...
// This hint should be set before an audio device is opened.
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_audio_device_raw_stream = &char(C.SDL_HINT_AUDIO_DEVICE_RAW_STREAM) // 'SDL_AUDIO_DEVICE_RAW_STREAM'
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_invalid_param_checks = &char(C.SDL_HINT_INVALID_PARAM_CHECKS) // 'SDL_INVALID_PARAM_CHECKS'
...
//
// NOTE: This hint is available since SDL 3.2.0.
pub const hint_hidapi_libusb_gamecube = &char(C.SDL_HINT_HIDAPI_LIBUSB_GAMECUBE) // 'SDL_HIDAPI_LIBUSB_GAMECUBE'
...
//
// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
pub const hint_joystick_hidapi_lg4ff = &char(C.SDL_HINT_JOYSTICK_HIDAPI_LG4FF) // 'SDL_JOYSTICK_HIDAPI_LG4FF'
...
//
// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
pub const hint_joystick_hidapi_8bitdo = &char(C.SDL_HINT_JOYSTICK_HIDAPI_8BITDO) // 'SDL_JOYSTICK_HIDAPI_8BITDO'
...
//
// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
pub const hint_joystick_hidapi_sinput = &char(C.SDL_HINT_JOYSTICK_HIDAPI_SINPUT) // 'SDL_JOYSTICK_HIDAPI_SINPUT'
...
//
// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
pub const hint_joystick_hidapi_zuiki = &char(C.SDL_HINT_JOYSTICK_HIDAPI_ZUIKI) // 'SDL_JOYSTICK_HIDAPI_ZUIKI'
...
//
// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
pub const hint_joystick_hidapi_flydigi = &char(C.SDL_HINT_JOYSTICK_HIDAPI_FLYDIGI) // 'SDL_JOYSTICK_HIDAPI_FLYDIGI'
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_joystick_hidapi_switch2 = &char(C.SDL_HINT_JOYSTICK_HIDAPI_SWITCH2) // 'SDL_JOYSTICK_HIDAPI_SWITCH2'
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_joystick_hidapi_gip = &char(C.SDL_HINT_JOYSTICK_HIDAPI_GIP) // 'SDL_JOYSTICK_HIDAPI_GIP'
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_joystick_hidapi_gip_reset_for_metadata = &char(C.SDL_HINT_JOYSTICK_HIDAPI_GIP_RESET_FOR_METADATA) // 'SDL_JOYSTICK_HIDAPI_GIP_RESET_FOR_METADATA'
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_kmsdrm_atomic = &char(C.SDL_HINT_KMSDRM_ATOMIC) // 'SDL_KMSDRM_ATOMIC'
...
//
// NOTE: This hint is available since SDL 3.2.0.
pub const hint_logging = &char(C.SDL_HINT_LOGGING) // 'SDL_LOGGING'// A variable controlling whether to force the application to become the
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_mac_press_and_hold = &char(C.SDL_HINT_MAC_PRESS_AND_HOLD) // 'SDL_MAC_PRESS_AND_HOLD'
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_mouse_dpi_scale_cursors = &char(C.SDL_HINT_MOUSE_DPI_SCALE_CURSORS) // 'SDL_MOUSE_DPI_SCALE_CURSORS'
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_render_direct3d11_warp = &char(C.SDL_HINT_RENDER_DIRECT3D11_WARP) // 'SDL_RENDER_DIRECT3D11_WARP'
...
pub const hint_ps2_gs_width = &char(C.SDL_HINT_PS2_GS_WIDTH) // 'SDL_PS2_GS_WIDTH'

// Variable controlling the height of the PS2's framebuffer in pixels
//
// By default, this variable is "448"
pub const hint_ps2_gs_height = &char(C.SDL_HINT_PS2_GS_HEIGHT) // 'SDL_PS2_GS_HEIGHT'

// Variable controlling whether the signal is interlaced or progressive
//
// - "0": Image is interlaced. (default)
// - "1": Image is progressive
pub const hint_ps2_gs_progressive = &char(C.SDL_HINT_PS2_GS_PROGRESSIVE) // 'SDL_PS2_GS_PROGRESSIVE'
...
// - "NTSC": 60hz region
// - "PAL": 50hz region
pub const hint_ps2_gs_mode = &char(C.SDL_HINT_PS2_GS_MODE) // 'SDL_PS2_GS_MODE'
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_video_metal_auto_resize_drawable = &char(C.SDL_HINT_VIDEO_METAL_AUTO_RESIZE_DRAWABLE) // 'SDL_VIDEO_METAL_AUTO_RESIZE_DRAWABLE'
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_video_match_exclusive_mode_on_move = &char(C.SDL_HINT_VIDEO_MATCH_EXCLUSIVE_MODE_ON_MOVE) // 'SDL_VIDEO_MATCH_EXCLUSIVE_MODE_ON_MOVE'
...
//
// NOTE: This hint is available since SDL 3.4.0.
pub const hint_windows_raw_keyboard_exclude_hotkeys = &char(C.SDL_HINT_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS) // 'SDL_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS'
